...
- **문법 포인트 컬러 = 연보라**(2026-08-29 사용자 확정 — "개념정리의 진한 녹색을 포인트
  ...
  갔다가 되돌림. 연노랑은 어휘 포인트라 못 씀). **값은 시간표 출석 색으로 확정된 연보라
  세트와 동일**(2026-08-29 "연보라가 지정된 컬러와 다릅니다" — 임의 값 쓰지 말 것):
  칩·선택·버튼 = #C4A9E4 바탕 + #43307A 글자, 진한 강조(진행 바·밑줄·아이콘) = #8E6BC8,
  연한 바탕 = #E7DDF3(허브 아이콘 #E7DDF3/#8E6BC8).
